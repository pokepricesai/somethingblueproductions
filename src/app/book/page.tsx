...
export default function BookPage() {
  ...
  return (
    <>
      ...
      {/* ── HERO BAND ── */}
      <section style={{ position: 'relative', backgroundColor: '#1B3A5C', overflow: 'hidden', minHeight: '220px', display: 'flex', alignItems: 'flex-end', backgroundImage: 'radial-gradient(ellipse at 25% 40%, rgba(168,202,236,0.18) 0%, transparent 55%), radial-gradient(ellipse at 75% 70%, rgba(232,221,181,0.08) 0%, transparent 55%)' }}>
        ...
        <div className="book-inner">
          ...
          {mode === 'choose' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
              <div onClick={() => setMode('book')} style={{ backgroundColor: '#1B3A5C', padding: '2.5rem 2rem', cursor: 'pointer', position: 'relative', overflow: 'hidden', backgroundImage: 'radial-gradient(ellipse at 20% 40%, rgba(168,202,236,0.15) 0%, transparent 55%), radial-gradient(ellipse at 80% 70%, rgba(232,221,181,0.06) 0%, transparent 55%)' }}>
              ...
              <div onClick={() => setMode('gift')} style={{ backgroundColor: '#E8DDB5', padding: '2.5rem 2rem', cursor: 'pointer', position: 'relative', overflow: 'hidden' }}>
                <Image src={`${STORAGE}/hero-main.jpg`} alt="Something Blue Productions photography" fill sizes="100vw" style={{ objectFit: 'cover', opacity: 0.15 }} />
                <div style={{ position: 'relative', zIndex: 1 }}>
