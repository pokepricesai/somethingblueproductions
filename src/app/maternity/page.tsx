...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "Beautiful, elegant maternity photography across Cambridgeshire.",
  ...
  return (
    <>
      ...
      <section style={{ position: 'relative', display: 'flex', alignItems: 'flex-end', overflow: 'hidden', backgroundColor: '#4a3c50', minHeight: '90svh' }}>
        ...
        <Image src={`${STORAGE}/maternity-hero.jpg`} alt="Maternity photography Cambridgeshire" fill priority sizes="100vw" style={{ objectFit: 'cover', zIndex: 0 }} />
        <div className="m-hero-content" style={{ position: 'relative', zIndex: 2 }}>
          ...
          <h1 style={{ fontFamily: "'Carose', sans-serif", fontWeight: 300, fontSize: 'clamp(2.2rem, 5vw, 4.5rem)', lineHeight: 1.05, color: '#ffffff', marginBottom: '1.2rem', textTransform: 'none', maxWidth: '700px' }}>
            <span aria-hidden="true">Before they{' '}<span style={{ fontFamily: "'Stay Humble', cursive", fontSize: 'clamp(2.5rem, 5.5vw, 5rem)' }}>arrive.</span></span>
            <span style={{ position: 'absolute', width: 1, height: 1, padding: 0, margin: -1, overflow: 'hidden', clip: 'rect(0,0,0,0)', whiteSpace: 'nowrap', border: 0 }}>Maternity Photography in Cambridge &amp; Cambridgeshire</span>
          </h1>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div className="m-intro-grid">
            ...
            <div style={{ aspectRatio: '3/4', backgroundColor: '#c0a8b0', overflow: 'hidden', position: 'relative' }}>
              ...
              <Image src={`${STORAGE}/maternity-intro.jpg`} alt="Maternity studio session" fill sizes="(max-width: 900px) 100vw, 50vw" style={{ objectFit: 'cover', zIndex: 1 }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '0 0 3rem', backgroundColor: '#F5F0E8' }}>
        <div className="m-gallery-strip-header" style={{ marginBottom: '1.5rem', padding: '0 1.5rem', maxWidth: '1100px', margin: '0 auto 1.5rem'  }}>
          <div>
        ...
        <div style={{ display: 'flex', gap: '2px', overflowX: 'auto', scrollbarWidth: 'none', cursor: 'grab', padding: '0 1.5rem', justifyContent: 'safe center' }}>
          {[
            ...
            <div key={i} style={{ flexShrink: 0, width: item.w, aspectRatio: item.aspect, backgroundColor: item.color, overflow: 'hidden', position: 'relative' }}>
              ...
              <Image src={`${STORAGE}/${item.img}`} alt={`Maternity photography Cambridgeshire ${i + 1}`} fill sizes="300px" style={{ objectFit: 'cover', zIndex: 1 }} />
            </div>
          ))}
        </div>
      </section>
