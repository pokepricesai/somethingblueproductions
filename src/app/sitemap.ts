...
const PAGE_LAST_MODIFIED: Record<string, string> = {
  '/': '2026-08-25',
  '/weddings': '2026-08-25',
  '/engagement': '2026-08-25',
  '/gift-vouchers': '2026-08-25',
  '/gift-vouchers/newborn': '2026-08-25',
  '/gift-vouchers/family': '2026-08-25',
  '/gift-vouchers/engagement': '2026-08-25',
  '/packages': '2026-08-25',
  '/families': '2026-05-01',
  '/newborn': '2026-08-25',
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/engagement`, lastModified: lm('/engagement'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/gift-vouchers`, lastModified: lm('/gift-vouchers'), changeFrequency: 'monthly', priority: 0.8 },
    { url: `${BASE}/gift-vouchers/newborn`, lastModified: lm('/gift-vouchers/newborn'), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE}/gift-vouchers/family`, lastModified: lm('/gift-vouchers/family'), changeFrequency: 'monthly', priority: 0.7 },
    { url: `${BASE}/gift-vouchers/engagement`, lastModified: lm('/gift-vouchers/engagement'), changeFrequency: 'monthly', priority: 0.7 },
