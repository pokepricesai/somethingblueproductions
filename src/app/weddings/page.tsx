...
export const metadata: Metadata = {
  ...
  description: "Beautiful, natural wedding photography and videography across Cambridge, Cambridgeshire and beyond. Honest, unposed, and made to last. Two studios available for pre-wedding portraits.",
};
...
export default function WeddingsPage() {
  return (
    <>
      {/* ─── HERO ─── */}
      <section style={{ position: 'relative', display: 'flex', alignItems: 'flex-end', overflow: 'hidden', backgroundColor: '#5c3d30', minHeight: '90vh' }}>
        ...
        {/* Replace with real wedding hero image */}
        ...
        <div style={{ position: 'relative', zIndex: 2, padding: '0 4rem 5rem' }}>
          ...
          <h1 style={{ fontFamily: "'Carose', sans-serif", fontWeight: 300, fontSize: 'clamp(2.5rem, 5vw, 4.5rem)', lineHeight: 1.05, color: '#ffffff', marginBottom: '1.2rem', textTransform: 'none', maxWidth: '700px' }}>
            Your day, honestly{' '}
            <span style={{ fontFamily: "'Stay Humble', cursive", fontSize: 'clamp(2.8rem, 5.5vw, 5rem)' }}>captured.</span>
          </h1>
          <p style={{ fontFamily: "'Inter', sans-serif", fontWeight: 300, fontSize: '0.95rem', lineHeight: 1.75, color: 'rgba(245,240,232,0.72)', marginBottom: '2rem', maxWidth: '420px' }}>
      ...
      <section style={{ padding: '4rem 4rem', backgroundColor: '#F5F0E8' }}>
        <div style={{ maxWidth: '720px', margin: '0 auto' }}>
          <p style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.65rem', letterSpacing: '0.25em', textTransform: 'uppercase', color: '#9E9282', marginBottom: '1.5rem' }}>
            Our approach
          </p>
      ...
      <section style={{ padding: '0 4rem 4rem', backgroundColor: '#F5F0E8' }}>
        <div style={{ maxWidth: '1300px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2px' }}>
          ...
          <Link href="/weddings/photography" style={{ position: 'relative', display: 'block', aspectRatio: '4/3', backgroundColor: '#5c3d30', overflow: 'hidden', textDecoration: 'none' }}>
            ...
            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '2.5rem' }}>
              <p style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.6rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(245,240,232,0.5)', marginBottom: '0.5rem' }}>Still images</p>
              <h2 style={{ fontFamily: "'Carose', sans-serif", fontWeight: 300, fontSize: 'clamp(1.4rem, 2.5vw, 2rem)', color: '#ffffff', textTransform: 'none', marginBottom: '1rem' }}>Wedding Photography</h2>
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.82rem', color: 'rgba(245,240,232,0.65)', lineHeight: 1.7, marginBottom: '1.5rem', maxWidth: '320px' }}>Full day coverage, edited gallery, and a collection of images that genuinely feel like your day.</p>
          ...
          <Link href="/weddings/videography" style={{ position: 'relative', display: 'block', aspectRatio: '4/3', backgroundColor: '#3d2820', overflow: 'hidden', textDecoration: 'none' }}>
            <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(0,0,0,0.75) 0%, transparent 55%)' }} />
            <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '2.5rem' }}>
              <p style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.6rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(245,240,232,0.5)', marginBottom: '0.5rem' }}>Film</p>
              <h2 style={{ fontFamily: "'Carose', sans-serif", fontWeight: 300, fontSize: 'clamp(1.4rem, 2.5vw, 2rem)', color: '#ffffff', textTransform: 'none', marginBottom: '1rem' }}>Wedding Videography</h2>
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.82rem', color: 'rgba(245,240,232,0.65)', lineHeight: 1.7, marginBottom: '1.5rem', maxWidth: '320px' }}>A short film of your day — the voices, the music, the moments that a photograph alone can&apos;t hold.</p>
              <span style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.62rem', letterSpacing: '0.18em', textTransform: 'uppercase', color: 'rgba(245,240,232,0.55)', display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
                <span style={{ width: '18px', height: '1px', backgroundColor: 'currentColor', display: 'inline-block' }} />
                See more
              </span>
      ...
      <section style={{ padding: '0 4rem 4rem', backgroundColor: '#F5F0E8' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '2px', overflowX: 'auto', scrollbarWidth: 'none', cursor: 'grab' }}>
            {[
              { w: '260px', aspect: '2/3', color: '#8a6848' },
              { w: '380px', aspect: '3/2', color: '#a08070' },
              { w: '260px', aspect: '2/3', color: '#7a5848' },
              { w: '320px', aspect: '4/3', color: '#906858' },
              { w: '260px', aspect: '2/3', color: '#8a7060' },
            ].map((item, i) => (
      ...
      <section style={{ padding: '4rem 4rem', backgroundColor: '#E8DDB5' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2px' }}>
            {[
              { num: '01', title: 'Before the day', desc: "We have a proper conversation before anything is confirmed. We want to understand your day, your style, and what matters most to you — so nothing is a surprise." },
              ...
              <div key={step.num} style={{ padding: '2.5rem 2rem', backgroundColor: '#E8DDB5' }}>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem' }}>
            {[
              ...
              { quote: "Completely unobtrusive on the day — we genuinely forgot there was a photographer there. The results are beyond anything we hoped for. Emotional doesn't cover it.", name: 'Priya & James', detail: 'Ely · Autumn wedding' },
            ].map((t, i) => (
      ...
      <section style={{ padding: '4rem 4rem', backgroundColor: '#0d1b2a' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2px', marginBottom: '2rem' }}>
            {[
              ...
              { name: 'Complete', price: 'From £2,600', includes: ['Full day coverage', 'Two photographers', 'Wedding film', 'Online gallery', '600+ edited images', 'Print release', 'Engagement session'], highlight: false },
            ].map((pkg) => (
              <div key={pkg.name} style={{ padding: '2.5rem 2rem', backgroundColor: pkg.highlight ? '#1B3A5C' : 'rgba(255,255,255,0.04)', border: pkg.highlight ? 'none' : '1px solid rgba(168,202,236,0.1)' }}>
                ...
                <p style={{ fontFamily: "'Carose', sans-serif", fontWeight: 300, fontSize: '1.6rem', color: '#E8DDB5', textTransform: 'none', marginBottom: '1.5rem' }}>{pkg.price}</p>
      ...
      {/* ─── CTA ─── */}
      <section style={{ padding: '5rem 4rem', backgroundColor: '#0d1b2a', textAlign: 'center' }}>
