  ...
  return (
    <>
      ...
      <section style={{ position: 'relative', display: 'flex', alignItems: 'flex-end', overflow: 'hidden', backgroundColor: '#1b2a3a', minHeight: '80svh' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, backgroundColor: '#1b2a3a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <span style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.65rem', letterSpacing: '0.25em', textTransform: 'uppercase', color: 'rgba(168,202,236,0.15)', textAlign: 'center' }}>performance-hero.jpg</span>
        </div>
        <div className="p-hero-content" style={{ position: 'relative', zIndex: 2 }}>
          <p style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.65rem', letterSpacing: '0.25em', textTransform: 'uppercase', color: 'rgba(245,240,232,0.6)', marginBottom: '1rem' }}>
            Performance & Show Photography · Cambridge
          </p>
          <h1 style={{ fontFamily: "'Carose', sans-serif", fontWeight: 300, fontSize: 'clamp(2.2rem, 5vw, 4.5rem)', lineHeight: 1.05, color: '#ffffff', marginBottom: '1.2rem', textTransform: 'none', maxWidth: '700px' }}>
            The energy of live{' '}
            <span style={{ fontFamily: "'Stay Humble', cursive", fontSize: 'clamp(2.5rem, 5.5vw, 5rem)' }}>performance.</span>
          </h1>
      ...
      <section className="p-pad" style={{ backgroundColor: '#F5F0E8' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div className="p-intro-grid">
            ...
            <div style={{ aspectRatio: '3/4', backgroundColor: '#1b2a3a', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <span style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.55rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(168,202,236,0.2)', textAlign: 'center' }}>performance-gallery-01.jpg</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '3rem 0', backgroundColor: '#F5F0E8' }}>
        <div style={{ display: 'flex', gap: '2px', overflowX: 'auto', scrollbarWidth: 'none', cursor: 'grab', paddingLeft: '1.5rem' }}>
          {[
            { w: '220px', aspect: '2/3', color: '#1b2a3a', label: 'performance-gallery-01.jpg' },
            { w: '320px', aspect: '3/2', color: '#243040', label: 'performance-gallery-02.jpg' },
            { w: '220px', aspect: '2/3', color: '#1e2838', label: 'performance-gallery-03.jpg' },
            { w: '260px', aspect: '4/3', color: '#202830', label: 'performance-gallery-04.jpg' },
            { w: '220px', aspect: '2/3', color: '#1a2230', label: 'performance-gallery-05.jpg' },
          ].map((item, i) => (
            <div key={i} style={{ flexShrink: 0, width: item.w, aspectRatio: item.aspect, backgroundColor: item.color, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <span style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.5rem', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(168,202,236,0.25)', textAlign: 'center', padding: '0 0.5rem' }}>{item.label}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="p-pad" style={{ backgroundColor: '#0d1b2a', textAlign: 'center' }}>
        <div style={{ maxWidth: '520px', margin: '0 auto' }}>
          ...
          <div className="p-cta-buttons">
            ...
            <Link href="/commercial" style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.68rem', letterSpacing: '0.2em', textTransform: 'uppercase', border: '1px solid rgba(245,240,232,0.25)', color: 'rgba(245,240,232,0.6)', padding: '1rem 2.5rem', textDecoration: 'none', display: 'inline-block' }}>
