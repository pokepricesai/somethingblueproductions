  ...
  return (
    <>
      <style>{`
        ...
        .c-work-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 2px; }
        ...
        @media (min-width: 900px) {
          ...
          .c-work-grid { grid-template-columns: repeat(4, 1fr); }
      ...
      <section style={{ position: 'relative', display: 'flex', alignItems: 'flex-end', overflow: 'hidden', backgroundColor: '#2c2820', minHeight: '80svh' }}>
        ...
        <div style={{ position: 'absolute', inset: 0, backgroundColor: '#2c2820', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <span style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.65rem', letterSpacing: '0.25em', textTransform: 'uppercase', color: 'rgba(245,240,232,0.15)', textAlign: 'center' }}>commercial-hero.jpg</span>
        </div>
        <div className="c-hero-content" style={{ position: 'relative', zIndex: 2 }}>
          <p style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.65rem', letterSpacing: '0.25em', textTransform: 'uppercase', color: 'rgba(245,240,232,0.6)', marginBottom: '1rem' }}>
            Commercial Photography · Cambridge
          </p>
          <h1 style={{ fontFamily: "'Carose', sans-serif", fontWeight: 300, fontSize: 'clamp(2.2rem, 5vw, 4.5rem)', lineHeight: 1.05, color: '#ffffff', marginBottom: '1.2rem', textTransform: 'none', maxWidth: '700px' }}>
            Photography that{' '}
            <span style={{ fontFamily: "'Stay Humble', cursive", fontSize: 'clamp(2.5rem, 5.5vw, 5rem)' }}>works.</span>
          </h1>
          ...
          {[
            {
              ...
              desc: 'Product photography, brand visuals, social content and small business photography. Consistent, commercial-quality images that represent your business properly.',
              href: '/commercial/brand',
              color: '#3a3020',
            },
            {
              label: 'For performers & companies',
              title: 'Performance & Show Photography',
              desc: 'Theatre, dance, music, events and live performance photography. Fast, discreet, and designed to capture energy and emotion in difficult lighting conditions.',
              href: '/commercial/performance',
              color: '#1b2a3a',
            },
            {
              label: 'For performers, models & creatives',
              title: 'Creative Headshots',
              desc: 'Headshots for actors, performers, models and creatives. Not corporate — personal, characterful, and shot with the same editorial eye as our personal work.',
              href: '/commercial/headshots',
              color: '#2a2030',
            },
          ].map((service) => (
            <Link key={service.href} href={service.href} style={{ position: 'relative', display: 'block', aspectRatio: '3/4', backgroundColor: service.color, overflow: 'hidden', textDecoration: 'none' }}>
              <div style={{ position: 'absolute', inset: 0, background: 'linear-gradient(to top, rgba(0,0,0,0.8) 0%, transparent 50%)' }} />
              <div style={{ position: 'absolute', bottom: 0, left: 0, right: 0, padding: '1.8rem 2rem' }}>
      ...
      <section style={{ padding: '0 0 3rem', backgroundColor: '#F5F0E8' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '1.5rem', padding: '0 1.5rem' }}>
          ...
          <Link href="/commercial/portfolio" style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.65rem', letterSpacing: '0.18em', textTransform: 'uppercase', color: '#9E9282', textDecoration: 'none', borderBottom: '1px solid #DDD5C0', paddingBottom: '2px' }}>View all</Link>
        </div>
        <div style={{ display: 'flex', gap: '2px', overflowX: 'auto', scrollbarWidth: 'none', cursor: 'grab', paddingLeft: '1.5rem' }}>
          {[
            { w: '220px', aspect: '2/3', color: '#3a3020', label: 'commercial-headshot-01.jpg' },
            { w: '320px', aspect: '3/2', color: '#1b2a3a', label: 'commercial-performance-01.jpg' },
            { w: '220px', aspect: '2/3', color: '#2a2030', label: 'commercial-brand-01.jpg' },
            { w: '260px', aspect: '4/3', color: '#302820', label: 'commercial-headshot-02.jpg' },
            { w: '220px', aspect: '2/3', color: '#1a2838', label: 'commercial-performance-02.jpg' },
          ].map((item, i) => (
            <div key={i} style={{ flexShrink: 0, width: item.w, aspectRatio: item.aspect, backgroundColor: item.color, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <span style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.5rem', letterSpacing: '0.15em', textTransform: 'uppercase', color: 'rgba(245,240,232,0.25)', textAlign: 'center', padding: '0 0.5rem' }}>{item.label}</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="c-pad" style={{ backgroundColor: '#F5F0E8', textAlign: 'center' }}>
        <div style={{ maxWidth: '520px', margin: '0 auto' }}>
          ...
          <div className="c-cta-buttons">
            ...
            <Link href="/commercial/portfolio" style={{ fontFamily: "'Carose', sans-serif", fontSize: '0.68rem', letterSpacing: '0.2em', textTransform: 'uppercase', border: '1px solid rgba(27,58,92,0.3)', color: '#1B3A5C', padding: '1rem 2.5rem', textDecoration: 'none', display: 'inline-block' }}>
